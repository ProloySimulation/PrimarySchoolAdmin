...
public class UpazilaSummary_Subdis extends AppCompatActivity {
    ...
    private void getDivInfo() {
        final ProgressDialog progressDialog = new ProgressDialog(UpazilaSummary_Subdis.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.BASE_URL+Api.sub_details +subdistrictid,
                        ...
                        try {
                            ...
                            btn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent adminlist = new Intent(UpazilaSummary_Subdis.this, SchoolByUpzilaDiv.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(UpazilaSummary_Subdis.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
