...
public class UpazilaListAdpater_Div extends  RecyclerView.Adapter<UpazilaListAdpater_Div.ViewHolder> {

    private Context context;
    private List<Upazila> logList;

    public UpazilaListAdpater_Div(Context context, List<Upazila> list) {
        this.context = context;
        this.logList = list;
    }

    @Override
    public UpazilaListAdpater_Div.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_log, parent, false);
        return new UpazilaListAdpater_Div.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(UpazilaListAdpater_Div.ViewHolder holder, final int position) {
