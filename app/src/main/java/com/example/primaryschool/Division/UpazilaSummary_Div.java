...
public class UpazilaSummary_Div extends AppCompatActivity {
    ...
    private void getDivInfo() {
        final ProgressDialog progressDialog = new ProgressDialog(UpazilaSummary_Div.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.BASE_URL+Api.sub_details +subdistrictid,
                        ...
                        try {
                            ...
                            btn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent adminlist = new Intent(UpazilaSummary_Div.this, SchoolByUpzilaDiv.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(UpazilaSummary_Div.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.nav_home:
                Intent home = new Intent(UpazilaSummary_Div.this, DivisionActivity.class);
                startActivity(home);

                return true;
            case R.id.nav_graph:
                Intent log = new Intent(UpazilaSummary_Div.this, LogActivity.class);
                startActivity(log);

                return true;
            case R.id.notification:

                Intent notice = new Intent(UpazilaSummary_Div.this, NoticeActivity.class);
                startActivity(notice);

                return true;
            case R.id.nav_search:
                Intent profile = new Intent(UpazilaSummary_Div.this, ProfileActivity.class);
