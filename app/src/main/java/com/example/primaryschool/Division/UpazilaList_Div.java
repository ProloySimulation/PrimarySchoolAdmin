...
public class UpazilaList_Div extends AppCompatActivity {
    ...
    private void subdistrictList() {
        final ProgressDialog progressDialog = new ProgressDialog(UpazilaList_Div.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.nav_home:
                Intent home = new Intent(UpazilaList_Div.this, DivisionActivity.class);
                startActivity(home);

                return true;
            case R.id.nav_graph:
                Intent log = new Intent(UpazilaList_Div.this, LogActivity.class);
                startActivity(log);

                return true;
            case R.id.notification:

                Intent notice = new Intent(UpazilaList_Div.this, NoticeActivity.class);
                startActivity(notice);

                return true;
            case R.id.nav_search:
                Intent profile = new Intent(UpazilaList_Div.this, ProfileActivity.class);
