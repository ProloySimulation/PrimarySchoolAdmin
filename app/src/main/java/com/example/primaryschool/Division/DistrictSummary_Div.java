...
public class DistrictSummary_Div extends AppCompatActivity  {
...
/*        Calendar calendar = Calendar.getInstance();
    ...
    private void getDisInfo() {
        final ProgressDialog progressDialog = new ProgressDialog(DistrictSummary_Div.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.BASE_URL+Api.dist_details+districtid,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            divSummary(districtid);
                            progressDialog.dismiss();
                            btn.setVisibility(View.VISIBLE);
                            btn.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent adminlist = new Intent(DistrictSummary_Div.this, UpazilaList_Div.class);
                                    adminlist.putExtra("division_id",districtid);
                                    adminlist.putExtra("division_name_bn",districtname);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DistrictSummary_Div.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void divSummary(String id) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, Api.BASE_URL+Api.district_sum+id,
                new Response.Listener<String>() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.nav_home:
                Intent home = new Intent(DistrictSummary_Div.this, DivisionActivity.class);
                startActivity(home);

                return true;

            case R.id.nav_graph:
                Intent log = new Intent(DistrictSummary_Div.this, LogActivity.class);
                startActivity(log);
            ...
            case R.id.nav_search:
                Intent profile = new Intent(DistrictSummary_Div.this, ProfileActivity.class);
