...
public class SchoolSummary_Dis extends AppCompatActivity {
    Button btn;
...
*/
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.BASE_URL+Api.school_sum+schoolid,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SchoolSummary_Dis.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void getSummary(String div) {
        final ProgressDialog progressDialog = new ProgressDialog(SchoolSummary_Dis.this);
