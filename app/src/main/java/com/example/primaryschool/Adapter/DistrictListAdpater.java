...
public class DistrictListAdpater extends  RecyclerView.Adapter<DistrictListAdpater.ViewHolder> {

    private Context context;
    private List<District> logList;

    public DistrictListAdpater(Context context, List<District> list) {
        this.context = context;
        this.logList = list;
    }

    @Override
    public DistrictListAdpater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_log, parent, false);
        return new DistrictListAdpater.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(DistrictListAdpater.ViewHolder holder, final int position) {
        ...
        holder.tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent districtsummary = new Intent(context, DistrictSummary.class);
