...
public class SchoolListAdapter extends  RecyclerView.Adapter<SchoolListAdapter.ViewHolder> {
    ...
    public SchoolListAdapter(Context context, List<District> list) {
    ...
    public SchoolListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SchoolListAdapter.ViewHolder(v);
    }
    ...
    public void onBindViewHolder(SchoolListAdapter.ViewHolder holder, final int position) {
        ...
        holder.tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                districtsummary.putExtra("school_id",logList.get(position).getDistrictid());
                districtsummary.putExtra("school_name",logList.get(position).getDistrictname());
